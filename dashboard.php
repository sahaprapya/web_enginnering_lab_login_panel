...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($userId) {
        // Update
        $sql = "UPDATE reg2 SET username='$username', phone_number='$phone_number', first_name='$first_name', last_name='$last_name', gender='$gender' WHERE id=$userId";
    } else {
        // Create
...
<body>
    <div class="container">
        ...
        <h3>Search Users</h3>
        <input type="text" id="search" placeholder="Search by username"><br>
